...
const Header = () => {
  return (
   <>
   <div className='flex items-start justify-between h-16 px-4 pt-2 text-gray-200 bg-zinc-900'>
    <div className='relative'>
    <Search  className="absolute text-gray-400 -translate-y-1/2 top-1/2 left-3 "color="#6d6969" />
      <input type="text" placeholder='Search' className='h-10 text-lg border rounded-2xl bg-zinc-900 pl-11 pr-4   focus:outline-none active:outline-none w-[24rem]' ></input>
    </div>
